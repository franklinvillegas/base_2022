...
use App\Http\Controllers\EvaluacionDocenteCursoController;
...
Route::middleware('auth:api')->group(function () {
  ...
  Route::group(['prefix' => 'nivel'], function () {
    ...
    Route::get('llenar_combo', [NivelController::class, 'llenarCombo']);
    Route::get('listar', [NivelController::class, 'listar']);
    Route::post('crear', [NivelController::class, 'crear']);
    Route::put('modificar/{id}', [NivelController::class, 'modificar']);
    Route::post('modificar_imagen', [NivelController::class, 'modificarImagen']);
    Route::put('eliminar/{id}', [NivelController::class, 'eliminar']);
    Route::put('activar/{id}', [NivelController::class, 'activar']);
    Route::get('obtener_ayudas', [NivelController::class, 'obtenerAyudas']);
  });
  ...
  Route::group(['prefix' => 'alumno'], function () {
    Route::get('ver/{id}', [AlumnoController::class, 'ver']);
  ...
  //Grupo EvaluacionDocenteCurso
  Route::group(['prefix' => 'evaluacion_docente_curso'], function () {
    Route::get('ver/{id}', [EvaluacionDocenteCursoController::class, 'ver']);
    Route::get('llenar_combo', [EvaluacionDocenteCursoController::class, 'llenarCombo']);
    Route::get('listar/{tipo}', [EvaluacionDocenteCursoController::class, 'listar']);
    Route::get('listarEvaluacion/{id_evaluacion}', [EvaluacionDocenteCursoController::class, 'listarEvaluacion']);
    Route::post('crear', [EvaluacionDocenteCursoController::class, 'crear']);
    Route::put('modificar/{id}', [EvaluacionDocenteCursoController::class, 'modificar']);
    Route::post('modificar_imagen', [EvaluacionDocenteCursoController::class, 'modificarImagen']);
    Route::put('eliminar/{id}', [EvaluacionDocenteCursoController::class, 'eliminar']);
    Route::put('activar/{id}', [EvaluacionDocenteCursoController::class, 'activar']);
    Route::get('obtener_ayudas', [EvaluacionDocenteCursoController::class, 'obtenerAyudas']);
  });
  //Grupo Asistencia
